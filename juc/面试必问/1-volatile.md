...
- Volatile是Java虚拟机提供的**轻量级**的同步（synchronized）机制（三大特性）
  - 保证可见性
  - 不保证原子性
  - 禁止指令重排
...
![image-20200309153225758](https://image.imxyu.cn/file/image-20200309153225758.png)
...
- 工作内存：但我们实例化 new student，那么 age = 25 也是存储在主内存中
  ...
  ![image-20200309154435933](https://image.imxyu.cn/file/image-20200309154435933.png)
...
结果： 可以看到一直在等待，也就是说主线程没有感知到 AAA修改了变量number

![image-20220317095402071](https://image.imxyu.cn/file/image-20220317095402071.png)
...
![image-20200309162314054](https://image.imxyu.cn/file/image-20200309162314054.png)
...
接下来主线程要等待这20个线程运行完了之后再获取值，最笨的办法就是通过让主线程睡眠几秒钟（自己随意设置的），这样不好。

我们可以通过 `Thread.activeCount()`，来感知20个线程是否执行完毕，这里判断线程数是否大于2，为什么是2？因为默认是有两个线程的，一个main线程，一个gc线程
...
![image-20200309172900462](https://image.imxyu.cn/file/image-20200309172900462.png)

第二次：

![image-20200309172919295](https://image.imxyu.cn/file/image-20200309172919295.png)

第三次：

![image-20200309172929820](https://image.imxyu.cn/file/image-20200309172929820.png)

### 为什么出现数值丢失

![image-20200309174220675](https://image.imxyu.cn/file/image-20200309174220675.png)
...
![image-20200309183026329](https://image.imxyu.cn/file/image-20200309183026329.png)

完成上述操作后，我们在需要查看字节码的文件下，右键选择 External Tools即可

![image-20200309183115613](https://image.imxyu.cn/file/image-20200309183115613.png)
...
![image-20200309173315294](https://image.imxyu.cn/file/image-20200309173315294.png)
...
![image-20220317162402163](https://image.imxyu.cn/file/image-20220317162402163.png)
...
![image-20200310162654437](https://image.imxyu.cn/file/image-20200310162654437.png)
...
![image-20200310164513408](https://image.imxyu.cn/file/image-20200310164513408.png)
...
![image-20200310164720940](https://image.imxyu.cn/file/image-20200310164720940.png)
...
![image-20200310164946940](https://image.imxyu.cn/file/image-20200310164946940.png)

我们能够发现，通过引入Synchronized关键字，能够解决高并发环境下的单例模式问题

但是synchronized属于重量级的同步机制, 直接在整个方法上加太大了，会导致效率很低，因此采用的比较少
...
![image-20200310165703190](https://image.imxyu.cn/file/image-20200310165703190.png)
